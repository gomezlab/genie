...
for train_index, test_index in skf.split(X, y, groups):
    ...
    results.sort_values(by='rank_test_score').to_csv('../../results/hp_search/results_xgb_lasso_{}_{}_{}_{}_{}.csv'.format(drug, outcome, data_type, today_str, fold_count))
...
if not os.path.exists(out_folder):
    os.mkdir(out_folder)
    res_df.to_csv('../../results/lasso_runs/{}/results_xgb_{}_{}_{}_{}.csv'.format(today_str, drug, outcome, data_type, today_str))
else:
    res_df.to_csv('../../results/lasso_runs/{}/results_xgb_{}_{}_{}_{}.csv'.format(today_str, drug, outcome, data_type, today_str))
